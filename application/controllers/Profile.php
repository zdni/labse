...
class Profile extends User_Controller {
    ...
    public function update_profile_hr()
    {
        if( !$_POST ) return redirect( base_url('profile') );

        $this->form_validation->set_rules('hr_id', 'Id HR', 'required');
        $this->form_validation->set_rules('email', 'Email', 'required');
        $this->form_validation->set_rules('phone', 'Nomor Telepon', 'required');
        
        $alert = 'error';
        $message = 'Gagal Mengubah Profil Kontak! <br> Silahkan isi semua inputan!';
        if ( $this->form_validation->run() )
        {
            ...
            if( $this->hr_model->ubah( $hr_id, $data ) )
            {
                $alert = 'success';
                $message = 'Berhasil Mengubah Profil Kontak!';
            } else {
                $message = 'Gagal Mengubah Profil Kontak!';
            }
        }
